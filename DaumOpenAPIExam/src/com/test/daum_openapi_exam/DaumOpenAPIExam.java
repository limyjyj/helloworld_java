...
public class DaumOpenAPIExam {
	...
	public static void main(String[] args) {
		...
		String urlString = "https://apis.daum.net/shopping/search?apikey=a2e1b55c3a07cc9f9fac0d787230dd82&q="+keyword+"&result=20&pageno=3&output=json&sort=min_price";
		...
		try {
			...
			BufferedReader br = new BufferedReader(ir); //보조리더
			String line;
